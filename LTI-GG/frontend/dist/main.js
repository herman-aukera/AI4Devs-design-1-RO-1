...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{
			applications: _List_Nil,
			error: $elm$core$Maybe$Nothing,
			jobs: _List_Nil,
			loading: false,
			loggedIn: false,
			newApp: {candidate_id: '', id: '', job_id: ''},
			newJob: {description: '', id: '', title: ''}
		},
	...
	[
		...
		_List_fromArray(
			[
				...
				A4($rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0.07))
			]))
	]);
...
var $author$project$Main$DeleteApp = function (a) {
	return {$: 'DeleteApp', a: a};
};
...
var $author$project$Styles$button = _List_fromArray(
	[
		...
		_List_fromArray(
			[
				$rtfeldman$elm_css$Css$backgroundColor(
				$rtfeldman$elm_css$Css$hex('#fd4f00')),
				...
				A2($rtfeldman$elm_css$Css$property, 'transition', 'background 0.2s, box-shadow 0.2s'),
				$rtfeldman$elm_css$Css$hover(
				_List_fromArray(
					[
						$rtfeldman$elm_css$Css$backgroundColor(
						$rtfeldman$elm_css$Css$hex('#d84315'))
					])),
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Css$px(0),
						$rtfeldman$elm_css$Css$px(0),
						A4($rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0.10)),
...
var $author$project$Styles$listItem = _List_fromArray(
	[
		$rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
...
var $author$project$Main$applicationItemView = F2(
	function (model, app) {
		return A2(
			$rtfeldman$elm_css$Html$Styled$li,
			_Utils_ap(
				$author$project$Styles$listItem,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								...
								$rtfeldman$elm_css$Css$px(0),
								$rtfeldman$elm_css$Css$px(1),
								A4($rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0.03)),
								A2(
								$rtfeldman$elm_css$Css$padding2,
								$rtfeldman$elm_css$Css$px(10),
								$rtfeldman$elm_css$Css$px(12))
			...
			_List_fromArray(
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									$rtfeldman$elm_css$Css$px(16)),
									$rtfeldman$elm_css$Css$color(
									$rtfeldman$elm_css$Css$hex('#4a4e69'))
								]))
						]),
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('Application ID: ' + app.id)
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('Candidate: ' + app.candidate_id)
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('Job: ' + app.job_id)
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('Status: ' + app.status)
						])),
					A2(
					...
					_Utils_ap(
						...
						_List_fromArray(
							[
								...
								$author$project$Main$DeleteApp(app.id)),
								A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'aria-label', 'Delete Application')
							])),
					_List_fromArray(
						[
...
var $author$project$Main$SubmitNewApp = {$: 'SubmitNewApp'};
var $author$project$Main$UpdateNewAppCandidate = function (a) {
	return {$: 'UpdateNewAppCandidate', a: a};
};
var $author$project$Main$UpdateNewAppId = function (a) {
	return {$: 'UpdateNewAppId', a: a};
};
var $author$project$Main$UpdateNewAppJob = function (a) {
	return {$: 'UpdateNewAppJob', a: a};
};
...
var $author$project$Styles$input = _List_fromArray(
	[
		$rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
...
var $author$project$Main$dashViewAppForm = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				...
				$rtfeldman$elm_css$Html$Styled$Events$onSubmit($author$project$Main$SubmitNewApp)
			]),
		_List_fromArray(
			[
				A2(
				...
				_Utils_ap(
					$author$project$Styles$input,
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$placeholder('App ID'),
							$rtfeldman$elm_css$Html$Styled$Attributes$value(model.newApp.id),
							$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Main$UpdateNewAppId)
						])),
				_List_Nil),
				A2(
				$rtfeldman$elm_css$Html$Styled$input,
				_Utils_ap(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$placeholder('Candidate ID'),
							$rtfeldman$elm_css$Html$Styled$Attributes$value(model.newApp.candidate_id),
							$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Main$UpdateNewAppCandidate)
						])),
				_List_Nil),
				A2(
				$rtfeldman$elm_css$Html$Styled$input,
				_Utils_ap(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$placeholder('Job ID'),
							$rtfeldman$elm_css$Html$Styled$Attributes$value(model.newApp.job_id),
							$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Main$UpdateNewAppJob)
						])),
				_List_Nil),
				A2(
				$rtfeldman$elm_css$Html$Styled$button,
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Add Application')
					]))
			]));
};
var $author$project$Main$SubmitNewJob = {$: 'SubmitNewJob'};
var $author$project$Main$UpdateNewJobDesc = function (a) {
	return {$: 'UpdateNewJobDesc', a: a};
};
var $author$project$Main$UpdateNewJobId = function (a) {
	return {$: 'UpdateNewJobId', a: a};
};
var $author$project$Main$UpdateNewJobTitle = function (a) {
	return {$: 'UpdateNewJobTitle', a: a};
};
var $author$project$Main$dashViewJobForm = function (model) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$form,
		_List_fromArray(
			[
				...
				$rtfeldman$elm_css$Html$Styled$Events$onSubmit($author$project$Main$SubmitNewJob)
			]),
		_List_fromArray(
			[
				A2(
				...
				_Utils_ap(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$placeholder('Job ID'),
							$rtfeldman$elm_css$Html$Styled$Attributes$value(model.newJob.id),
							$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Main$UpdateNewJobId)
						])),
				_List_Nil),
				A2(
				$rtfeldman$elm_css$Html$Styled$input,
				_Utils_ap(
					...
					_List_fromArray(
						[
							...
							$rtfeldman$elm_css$Html$Styled$Attributes$value(model.newJob.title),
							$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Main$UpdateNewJobTitle)
						])),
				_List_Nil),
				A2(
				$rtfeldman$elm_css$Html$Styled$input,
				_Utils_ap(
					...
					_List_fromArray(
						[
							...
							$rtfeldman$elm_css$Html$Styled$Attributes$value(model.newJob.description),
							$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Main$UpdateNewJobDesc)
						])),
				_List_Nil),
				A2(
				$rtfeldman$elm_css$Html$Styled$button,
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Add Job')
					]))
			]));
};
...
var $author$project$Main$dashViewList = function (items) {
	return $elm$core$List$isEmpty(items) ? A2(
		...
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$text('No items found.')
			])) : A2(
...
var $author$project$Styles$h2 = _List_fromArray(
	[
		$rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
...
var $author$project$Main$dashViewSection = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'aria-labelledby', title)
				]),
			_List_fromArray(
				[
					A2(
					$rtfeldman$elm_css$Html$Styled$h2,
					$author$project$Styles$h2,
					_List_fromArray(
						[
...
var $author$project$Styles$errorText = _List_fromArray(
	[
		$rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
				$rtfeldman$elm_css$Css$color(
				$rtfeldman$elm_css$Css$hex('#d90429')),
				$rtfeldman$elm_css$Css$fontWeight($rtfeldman$elm_css$Css$bold),
				$rtfeldman$elm_css$Css$marginTop(
				$rtfeldman$elm_css$Css$px(12))
			]))
	]);
var $author$project$Main$DeleteJob = function (a) {
	return {$: 'DeleteJob', a: a};
};
var $author$project$Main$jobItemView = F2(
	function (model, job) {
		return A2(
			$rtfeldman$elm_css$Html$Styled$li,
			_Utils_ap(
			...
			_List_fromArray(
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									$rtfeldman$elm_css$Css$color(
									$rtfeldman$elm_css$Css$hex('#22223b'))
								]))
						]),
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text(job.title)
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text(job.description)
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('Status: ' + job.status)
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$button,
					_Utils_ap(
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Events$onClick(
								$author$project$Main$DeleteJob(job.id)),
								A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'aria-label', 'Delete Job')
							])),
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('Delete')
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Welcome, admin!')
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$button,
						_Utils_ap(
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Main$Logout),
									A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'aria-label', 'Logout')
								])),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						A2(
						$author$project$Main$dashViewSection,
						'Jobs',
						A2(
							$rtfeldman$elm_css$Html$Styled$div,
							_List_Nil,
							_List_fromArray(
								[
									$author$project$Main$dashViewJobForm(model),
									$author$project$Main$dashViewList(
									A2(
										$elm$core$List$map,
										$author$project$Main$jobItemView(model),
										model.jobs))
								]))),
						A2(
						$author$project$Main$dashViewSection,
						...
						A2(
							...
							_List_fromArray(
								[
									$author$project$Main$dashViewAppForm(model),
									$author$project$Main$dashViewList(
									A2(
										$elm$core$List$map,
										$author$project$Main$applicationItemView(model),
										model.applications))
								])))
					])),
				function () {
				...
				if (_v0.$ === 'Just') {
					...
					return A2(
						$rtfeldman$elm_css$Html$Styled$div,
						$author$project$Styles$errorText,
						_List_fromArray(
							[
...
var $author$project$Styles$h1 = _List_fromArray(
	[
		$rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Please log in (admin/admin123)')
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$button,
				_Utils_ap(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Main$Login),
							A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'aria-label', 'Login')
						])),
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Login')
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Styles$h1,
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('LTI ATS Dashboard')
							])),
						model.loggedIn ? $author$project$Main$dashboardView(model) : $author$project$Main$loginView(model)
					]))
			]));
};
var $author$project$Main$toUnstyledView = A2($elm$core$Basics$composeL, $rtfeldman$elm_css$Html$Styled$toUnstyled, $author$project$Main$view);
var $author$project$Main$AppCreated = function (a) {
	return {$: 'AppCreated', a: a};
};
var $author$project$Main$AppDeleted = function (a) {
	return {$: 'AppDeleted', a: a};
};
var $author$project$Main$JobCreated = function (a) {
	return {$: 'JobCreated', a: a};
};
var $author$project$Main$JobDeleted = function (a) {
	return {$: 'JobDeleted', a: a};
};
var $elm$core$Basics$always = F2(
	function (a, _v0) {
		return a;
	});
var $author$project$Main$Application = F4(
	function (id, candidate_id, job_id, status) {
		return {candidate_id: candidate_id, id: id, job_id: job_id, status: status};
	});
var $elm$json$Json$Decode$map4 = _Json_map4;
var $author$project$Main$applicationDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Main$Application,
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'candidate_id', $elm$json$Json$Decode$string),
...
var $author$project$Main$ApplicationsFetched = function (a) {
	return {$: 'ApplicationsFetched', a: a};
};
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Main$applicationsDecoder = $elm$json$Json$Decode$list($author$project$Main$applicationDecoder);
...
var $author$project$Main$fetchApplications = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Main$ApplicationsFetched, $author$project$Main$applicationsDecoder),
		url: 'http://localhost:4000/api/applications'
	});
var $author$project$Main$JobsFetched = function (a) {
	return {$: 'JobsFetched', a: a};
};
var $author$project$Main$Job = F4(
	function (id, title, description, status) {
		return {description: description, id: id, status: status, title: title};
	});
var $author$project$Main$jobDecoder = A5(
	$elm$json$Json$Decode$map4,
	...
	A2($elm$json$Json$Decode$field, 'status', $elm$json$Json$Decode$string));
var $author$project$Main$jobsDecoder = $elm$json$Json$Decode$list($author$project$Main$jobDecoder);
var $author$project$Main$fetchJobs = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Main$JobsFetched, $author$project$Main$jobsDecoder),
		...
		switch (msg.$) {
			case 'Login':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{loading: true, loggedIn: true}),
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[$author$project$Main$fetchJobs, $author$project$Main$fetchApplications])));
			case 'Logout':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{applications: _List_Nil, error: $elm$core$Maybe$Nothing, jobs: _List_Nil, loading: false, loggedIn: false}),
					$elm$core$Platform$Cmd$none);
			case 'FetchJobs':
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'JobsFetched':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{error: $elm$core$Maybe$Nothing, jobs: jobs, loading: false}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								error: $elm$core$Maybe$Just('Failed to fetch jobs'),
								loading: false
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'FetchApplications':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{loading: true}),
					$author$project$Main$fetchApplications);
			case 'ApplicationsFetched':
				if (msg.a.$ === 'Ok') {
					var applications = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{applications: applications, error: $elm$core$Maybe$Nothing, loading: false}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								error: $elm$core$Maybe$Just('Failed to fetch applications'),
								loading: false
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'UpdateNewJobId':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							newJob: {description: model.newJob.description, id: v, title: model.newJob.title}
						}),
					$elm$core$Platform$Cmd$none);
			case 'UpdateNewJobTitle':
				var v = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							newJob: {description: model.newJob.description, id: model.newJob.id, title: v}
						}),
					$elm$core$Platform$Cmd$none);
			case 'UpdateNewJobDesc':
				var v = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							newJob: {description: v, id: model.newJob.id, title: model.newJob.title}
						}),
					$elm$core$Platform$Cmd$none);
			case 'SubmitNewJob':
					...
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
								_Utils_Tuple2(
								'id',
								$elm$json$Json$Encode$string(model.newJob.id)),
								_Utils_Tuple2(
								'title',
								$elm$json$Json$Encode$string(model.newJob.title)),
								_Utils_Tuple2(
								'description',
								$elm$json$Json$Encode$string(model.newJob.description))
							])));
				return _Utils_Tuple2(
					model,
					$elm$http$Http$post(
						{
							body: body,
							expect: A2($elm$http$Http$expectJson, $author$project$Main$JobCreated, $author$project$Main$jobDecoder),
							url: 'http://localhost:4000/api/jobs'
						}));
			case 'JobCreated':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								error: $elm$core$Maybe$Nothing,
								jobs: A2($elm$core$List$cons, job, model.jobs),
								newJob: {description: '', id: '', title: ''}
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								error: $elm$core$Maybe$Just('Failed to create job')
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'DeleteJob':
					...
					$elm$http$Http$request(
						{
							...
							expect: $elm$http$Http$expectString(
								function (result) {
									return $author$project$Main$JobDeleted(
										A2(
											$elm$core$Result$map,
											$elm$core$Basics$always(jid),
											result));
								}),
							headers: _List_Nil,
							method: 'DELETE',
							...
							url: 'http://localhost:4000/api/jobs/' + jid
						}));
			case 'JobDeleted':
				if (msg.a.$ === 'Ok') {
					var jid = msg.a.a;
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								error: $elm$core$Maybe$Just('Failed to delete job')
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'UpdateNewAppId':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							newApp: {candidate_id: model.newApp.candidate_id, id: v, job_id: model.newApp.job_id}
						}),
					$elm$core$Platform$Cmd$none);
			case 'UpdateNewAppCandidate':
				var v = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							newApp: {candidate_id: v, id: model.newApp.id, job_id: model.newApp.job_id}
						}),
					$elm$core$Platform$Cmd$none);
			case 'UpdateNewAppJob':
				var v = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							newApp: {candidate_id: model.newApp.candidate_id, id: model.newApp.id, job_id: v}
						}),
					$elm$core$Platform$Cmd$none);
			case 'SubmitNewApp':
				var body = $elm$http$Http$jsonBody(
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
								_Utils_Tuple2(
								'id',
								$elm$json$Json$Encode$string(model.newApp.id)),
								_Utils_Tuple2(
								'candidate_id',
								$elm$json$Json$Encode$string(model.newApp.candidate_id)),
								_Utils_Tuple2(
								'job_id',
								$elm$json$Json$Encode$string(model.newApp.job_id))
							])));
				return _Utils_Tuple2(
					model,
					$elm$http$Http$post(
						{
							body: body,
							expect: A2($elm$http$Http$expectJson, $author$project$Main$AppCreated, $author$project$Main$applicationDecoder),
							url: 'http://localhost:4000/api/applications'
						}));
			case 'AppCreated':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								applications: A2($elm$core$List$cons, app, model.applications),
								error: $elm$core$Maybe$Nothing,
								newApp: {candidate_id: '', id: '', job_id: ''}
							}),
						$elm$core$Platform$Cmd$none);
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								error: $elm$core$Maybe$Just('Failed to create application')
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'DeleteApp':
					...
					$elm$http$Http$request(
						{
							...
							expect: $elm$http$Http$expectString(
								function (result) {
									return $author$project$Main$AppDeleted(
										A2(
											$elm$core$Result$map,
											$elm$core$Basics$always(aid),
											result));
								}),
							headers: _List_Nil,
							method: 'DELETE',
							timeout: $elm$core$Maybe$Nothing,
							tracker: $elm$core$Maybe$Nothing,
							url: 'http://localhost:4000/api/applications/' + aid
						}));
			default:
				if (msg.a.$ === 'Ok') {
					var aid = msg.a.a;
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								error: $elm$core$Maybe$Just('Failed to delete application')
							}),
						$elm$core$Platform$Cmd$none);
				}
		}
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		...
		view: $author$project$Main$toUnstyledView
	});
